          ...
          <div className="app-container">
            <div className="main-layout row" style={{ height: "100%" }}>
              <Routes>
                ...
                />
                <Route
                  path="/list-book-borrowed/order-book-detail/:orderId"
                  element={
                    <ProtectedRoute roles={["borrower"]}>
                      <OrderDetail />
                    </ProtectedRoute>
                ...
                />
                <Route
                  path="/list-news-admin/create-news"
                  element={
                    <ProtectedRoute roles={["librarian"]}>
                      <CreateNews />
                    </ProtectedRoute>
                ...
                />
                <Route
                  path="/list-news-admin/update-news/:id"
                  element={
                    <ProtectedRoute roles={["librarian"]}>
                      <UpdateNews />
                    </ProtectedRoute>
                ...
                {/* Admin Routes */}
                <Route
                  path="/account-list/create-account"
                  element={
                ...
                />
                <Route
                  path="/account-list/update-account/:id"
                  element={
                    <ProtectedRoute roles={["admin"]}>
                      <UpdateAccount />
                    </ProtectedRoute>
                ...
                />
                <Route
                  path="/list-book-set/create-book"
                  element={
                    <ProtectedRoute roles={["admin"]}>
                      <CreateBook />
                    </ProtectedRoute>
                ...
                />
                <Route
                  path="/list-book-set/update-bookset/:id"
                  element={
                    <ProtectedRoute roles={["admin"]}>
                      <UpdateBookSet />
                    </ProtectedRoute>
                ...
                />
                <Route
                  path="/list-penalty-reasons/update-penalty-reason/:id"
                  element={
                    <ProtectedRoute roles={["admin"]}>
                      <UpdatePenaltyReason />
                    </ProtectedRoute>
                ...
                />
                <Route
                  path="/list-penalty-reasons/create-penalty-reason"
                  element={
                    <ProtectedRoute roles={["admin"]}>
                      <CreatePenaltyReason />
                    </ProtectedRoute>
...
const ProtectedRoute = ({ roles, children }) => {
  ...
  const menuItems = {
    ...
    admin: [
      ...
      {
        path: "/list-penalty-reasons",
        label: "Quản lý mức phạt",
        icon: "fa fa fa-window-close-o",
      },
      { path: "/chart", label: "Thống kê", icon: "fa fa-bar-chart" },
    ],
  };
