        ...
        <div className="row">
          ...
          <div className="col-md-3">
            <div className="border p-3 text-center mb-3">
              ...
              <div className="mb-3">
                <label htmlFor="imageUpload" className="form-label">Hình ảnh sách</label>
                <input 
                  type="file" 
          ...
          <div className="col-md-9">
            <div className="row">
              ...
              <div className="col-md-6">
                <div className="mb-3">
                  <label htmlFor="catalog_id" className="form-label">Danh mục:</label>
                  <select 
              ...
              {/* Form Fields */}
              {[
                { label: "ISBN", id: "isbn", type: "text", placeholder: "Nhập mã ISBN" },
                { label: "Giá", id: "price", type: "number", placeholder: "Nhập giá sách" },
                { label: "Mã sách", id: "code", type: "text", placeholder: "Nhập mã sách" },
                { label: "Tên sách", id: "title", type: "text", placeholder: "Nhập tên sách" },
                { label: "Tác giả", id: "author", type: "text", placeholder: "Nhập tên tác giả" },
                { label: "Năm xuất bản", id: "publishedYear", type: "date" },
                { label: "Nhà xuất bản", id: "publisher", type: "text", placeholder: "Nhập tên nhà xuất bản" },
                { label: "Mô tả sách", id: "physicalDescription", type: "text", placeholder: "Nhập mô tả sách" },
                { label: "Mã kệ sách", id: "shelfLocationCode", type: "text", placeholder: "Nhập mã kệ sách" },
                { label: "Số lượng", id: "totalCopies", type: "number", placeholder: "Nhập số lượng sách" }
